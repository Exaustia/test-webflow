...
class IndexView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '6171de626e35f76c7d76f3eb'
            ...
            <div style={{opacity: 0}} className="af-class-page-wrap">
              <div data-collapse="medium" data-animation="over-right" data-duration={400} data-easing="ease" data-easing2="ease" role="banner" className="af-class-navbar w-nav">
                <div className="af-class-container af-class-nav-container">
                  <a href="index.html" aria-current="page" className="af-class-brand w-nav-brand w--current"><img src="images/Black.svg" alt className="af-class-brand-logo" /></a>
                  <div className="af-class-nav-right-wrap">
                    <nav role="navigation" className="af-class-nav-menu w-nav-menu">
                      <a href="about.html" className="af-class-nav-link w-nav-link">About</a>
                      <a href="free-workouts.html" className="af-class-nav-link w-nav-link">Free Workouts</a>
                      <a href="shop.html" className="af-class-nav-link w-nav-link">Shop</a>
                      <a href="contact.html" className="af-class-button af-class-small w-button">Book a call</a>
                    </nav>
                ...
                <div className="af-class-container">
                  <div data-delay={4000} data-animation="fade" className="af-class-hero-slider w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit={0} data-nav-spacing={10} data-duration={1000} data-infinite="true">
                    <div className="w-slider-mask">
                      <div data-w-id="ec2afc2d-f943-794b-6c3e-3dc130fbfeed" className="w-slide">
                        <div className="af-class-hero-slider-content">
                          ...
                          <div id="w-node-f2bd7fdc-a738-1450-b4f9-1b53880bc1f6-7d76f3eb" style={{opacity: 0, WebkitTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', MozTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', msTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', transform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)'}} className="af-class-column af-class-max-600">
                            ...
                            <p className="af-class-big-paragraph af-class-max-500">After getting a bachelors in nutrition and fitness training I started working with people all around and changing their lives forever.</p>
                            <a href="about.html" className="af-class-button w-button">Online coaching</a>
                          </div>
                        </div>
                      </div>
                      <div data-w-id="8e130818-647a-5ae2-c911-1131eabfb306" className="w-slide">
                        <div className="af-class-hero-slider-content">
                          ...
                          <div id="w-node-_8e130818-647a-5ae2-c911-1131eabfb30d-7d76f3eb" style={{opacity: 0, WebkitTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', MozTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', msTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', transform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)'}} className="af-class-column af-class-max-600">
                      ...
                      <div data-w-id="b6ee397e-34f8-d374-0a5c-1ecf5c1e6307" className="w-slide">
                        <div className="af-class-hero-slider-content">
                          ...
                          <div id="w-node-b6ee397e-34f8-d374-0a5c-1ecf5c1e630e-7d76f3eb" style={{opacity: 0, WebkitTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', MozTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', msTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', transform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)'}} className="af-class-column af-class-max-600">
                            <div className="af-class-label af-class-_15-margin">Make a change today<br /></div>
                    ...
                    <div className="af-class-hero-nav-arrow af-class-left-arrow w-slider-arrow-left">
                      <div className="af-class-arrow-nav af-class-left-arrow"><img src="images/AArrow.svg" alt /></div>
                    </div>
              ...
              <div className="af-class-section af-class-social-proof af-class-wf-section">
                <div className="af-class-container af-class-grid-3">
                  <div className="af-class-column af-class-flex-center">
                    <h4 className="af-class-_10-margin">1900+</h4>
                    <div className="af-class-label af-class-grey-label">happy clients</div>
                  </div>
                  <div className="af-class-column af-class-flex-center">
                    <h4 className="af-class-_10-margin">5 yrs</h4>
                    <div className="af-class-label af-class-grey-label">of experience</div>
                  </div>
                  <div className="af-class-column af-class-flex-center">
                    <h4 className="af-class-_10-margin">156K</h4>
                    <div className="af-class-label af-class-grey-label">following me</div>
                  </div>
                </div>
              ...
              <div data-w-id="704f228a-8df5-ffa9-c2aa-29c84ad7d262" className="af-class-section af-class-features af-class-wf-section">
                <div className="af-class-container af-class-features-grid">
                  <div id="w-node-_8d350ed8-e9a4-eb03-1dcf-82faec0a87df-7d76f3eb" className="af-class-column af-class-feature-headline">
                    <h2 className="af-class-max-800">The journey to a healthier body starts right now</h2>
                    <a href="about.html" className="af-class-button w-button">Online coaching</a>
                  </div>
                  <div id="w-node-_1ac6e14c-5d80-b4fb-1311-8131a2fe412d-a2fe412d" className="af-class-column af-class-feature-column">
                    ...
                    <h4 className="af-class-feature-max">Learn to live a healthy life with fitness</h4>
                    <p className="af-class-max-400 af-class-no-margin">Changing your lifestyle with a fast paced life may seem hard or impossible, but with small steps each week you can achieve your dream physique and live a healthier life. </p>
                  </div>
                  <div id="w-node-_1ac6e14c-5d80-b4fb-1311-8131a2fe412d-a2fe412d" className="af-class-column af-class-feature-column">
                    <div className="af-class-feature-img-and-graident">
                      <div className="af-class-feature-image-mask"><img src="images/logan-weaver-24LpwagvuDY-unsplash.jpg" alt sizes="(max-width: 479px) 150px, 300px" srcSet="images/logan-weaver-24LpwagvuDY-unsplash-p-500.jpeg 500w, images/logan-weaver-24LpwagvuDY-unsplash-p-800.jpeg 800w, images/logan-weaver-24LpwagvuDY-unsplash-p-1080.jpeg 1080w" className="af-class-feature-image" /></div>
                      <div className="af-class-feature-gradient" />
                    </div>
                  ...
                  <div id="w-node-_1ac6e14c-5d80-b4fb-1311-8131a2fe412d-a2fe412d" className="af-class-column af-class-feature-column">
                    <div className="af-class-feature-img-and-graident">
                      <div className="af-class-feature-image-mask"><img src="images/logan-weaver-Oyw8t2UTUWQ-unsplash.jpg" alt sizes="(max-width: 479px) 150px, 300px" srcSet="images/logan-weaver-Oyw8t2UTUWQ-unsplash-p-500.jpeg 500w, images/logan-weaver-Oyw8t2UTUWQ-unsplash-p-800.jpeg 800w, images/logan-weaver-Oyw8t2UTUWQ-unsplash-p-1080.jpeg 1080w, images/logan-weaver-Oyw8t2UTUWQ-unsplash-p-1600.jpeg 1600w" className="af-class-feature-image" /></div>
                      <div className="af-class-feature-gradient" />
                    </div>
              ...
              <div data-w-id="7fddf232-87f5-9178-f759-6162de48fac6" className="af-class-section af-class-free-classes af-class-wf-section">
                <div className="af-class-container af-class-free-plan-container">
                  <div className="af-class-column af-class-workouts-headline">
                    <h2 className="af-class-jumbo af-class-max-800">Free home workouts and fitness plans</h2>
                    <p className="af-class-big-paragraph af-class-max-600">With free online classes people who don’t have the time or money to afford a personal coach can make change their lives forever.</p>
                    <a href="free-workouts.html" className="af-class-button w-button">View all</a>
                  </div>
              ...
              <div data-w-id="c0ad97f2-2461-377f-0d16-9bb4ea129ed1" className="af-class-section af-class-premium-classes af-class-wf-section">
                <div className="af-class-container af-class-free-plan-container">
                  <div className="af-class-column af-class-workouts-headline">
                    <h2 className="af-class-jumbo af-class-max-800">Free home workouts and fitness plans</h2>
                    <p className="af-class-big-paragraph af-class-max-600">I’ve created these premium fitness classes for everyone starting from beginner to advanced level with an in depth FAQ.</p>
              ...
              <div data-w-id="4cb83808-f988-e8d9-cf74-c6011c7b007b" className="af-class-section af-class-call-section af-class-wf-section">
                <div className="af-class-container af-class-grid-2">
                  <div id="w-node-_48f1e152-304c-af08-bac2-2094cbc0c067-7d76f3eb" className="af-class-column af-class-description-heading">
                  ...
                  <div id="w-node-d7b1a011-026b-afea-5499-7750c3a8ba54-7d76f3eb" className="af-class-description-image-wrap"><img src="images/Rectangle-441.png" alt className="af-class-description-image" /></div>
                </div>
              ...
              <div className="af-class-section af-class-newsletter-section af-class-wf-section">
                <div className="af-class-container">
                  <div className="af-class-newsletter-form w-form">
                    <form id="email-form" name="email-form" data-name="Email Form" className="af-class-form-content">
              ...
              <div className="af-class-section af-class-footer-section af-class-wf-section">
                <div className="af-class-container af-class-footer-container">
                  <div id="w-node-_1d6466da-e94d-115c-c97d-71e22c54b454-2c54b452" className="af-class-column">
                    <a href="#" className="af-class-footer-brand w-nav-brand"><img src="images/Black_1.svg" alt className="af-class-brand-logo" /></a>
                  </div>
