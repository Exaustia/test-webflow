          ...
          <div>
            <div data-collapse="medium" data-animation="default" data-duration={400} data-easing="ease" data-easing2="ease" role="banner" className="af-class-navbar w-nav">
              <div className="w-container">
                <a href="index.html" aria-current="page" className="af-class-brand-wrapper w-nav-brand w--current">
            ...
            <div className="af-class-section af-class-hero af-class-wf-section">
              <div className="w-container">
                ...
                <h1 className="af-class-huge-heading">beautiful &amp; POWERFUL</h1>
                <p className="af-class-subtitle">Terminal is a time tracking web app and iPhone app that will change your life.&nbsp;</p>
                <a href="sign-up.html" className="af-class-button">GET STARTED NOW</a>
                <a href="#learn-more" className="af-class-outline-button">LEARN MORE</a>
                <div className="af-class-image-crop af-class-hero"><img src="images/black-ipad.png" width={480} sizes="(max-width: 767px) 92vw, 480px" srcSet="images/black-ipad-p-500x650.png 500w, images/black-ipad-p-800x1039.png 800w, images/black-ipad-p-1080x1403.png 1080w, images/black-ipad.png 1938w" alt /></div>
              </div>
            </div>
            <div className="af-class-section af-class-press af-class-wf-section">
              <div className="w-container">
                ...
                <div className="af-class-press-image-wrapper"><img src="images/logo_Forbes.svg" alt className="af-class-press-logo" /></div>
                <div className="af-class-press-image-wrapper"><img src="images/logo_Fastcompany.svg" alt className="af-class-press-logo" /></div>
                <div className="af-class-press-image-wrapper"><img src="images/logo_Wired.svg" alt className="af-class-press-logo" /></div>
                <div className="af-class-press-image-wrapper"><img src="images/logo_zdnet.svg" alt className="af-class-press-logo" /></div>
                <div className="af-class-press-image-wrapper">
                  <a href="#" className="w-inline-block"><img src="images/logo_techcrunch.svg" alt className="af-class-press-logo" /></a>
                </div>
              </div>
            </div>
            <div id="learn-more" className="af-class-section af-class-darkgrey af-class-wf-section">
              <div className="w-container">
                <div className="w-row">
                  <div className="w-col w-col-8">
                    ...
                    <a href="sign-up.html" className="af-class-get-started-link">Get started now&nbsp;&nbsp;&nbsp;❯&nbsp;</a>
                  </div>
                  <div className="af-class-center w-col w-col-4"><img src="images/All-devices.png" sizes="(max-width: 479px) 64vw, (max-width: 767px) 46vw, (max-width: 991px) 229.328125px, 299.984375px" srcSet="images/All-devices-p-500x288.png 500w, images/All-devices.png 1131w" alt className="af-class-all-devices-image" /></div>
                </div>
              </div>
            </div>
              ...
              <div className="w-container">
                <div className="w-row">
                  <div className="w-col w-col-7">
                    <div className="af-class-image-crop"><img src="images/black-ipad.png" width={490} sizes="(max-width: 479px) 92vw, (max-width: 767px) 88vw, (max-width: 991px) 416.328125px, 490px" srcSet="images/black-ipad-p-500x650.png 500w, images/black-ipad-p-800x1039.png 800w, images/black-ipad-p-1080x1403.png 1080w, images/black-ipad.png 1938w" alt className="af-class-ipad-image" /></div>
                  </div>
                  <div className="w-col w-col-5">
                    <h2>Easy to use</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla.</p>
                    <ul role="list" className="af-class-feature-list w-list-unstyled">
                      <li className="af-class-feature-item w-clearfix">
                        <div className="af-class-feature-icon-wrapper"><img src="images/icon_56icon_55.png" width={30} alt className="af-class-feature-icon" /></div>
                        <div className="af-class-feature-text af-class-title">Record your work.</div>
                        <div className="af-class-feature-text">Vivamus sollicitudin, felis vitae facilisis.</div>
                      </li>
                      <li className="af-class-feature-item w-clearfix">
                        <div className="af-class-feature-icon-wrapper"><img src="images/icon_52icon_51.png" width={30} alt className="af-class-feature-icon" /></div>
                        <div className="af-class-feature-text af-class-title">Play it back.</div>
                        <div className="af-class-feature-text">Vivamus sollicitudin, felis vitae facilisis mollis, diam.</div>
                      </li>
                      <li className="af-class-feature-item w-clearfix">
                        <div className="af-class-feature-icon-wrapper"><img src="images/icon_54icon_53.png" width={30} alt className="af-class-feature-icon" /></div>
                        <div className="af-class-feature-text af-class-title">Pause at any moment.</div>
                        <div className="af-class-feature-text">Vivamus sollicitudin, felis vitae facilisis mollis.</div>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="w-container">
                <div className="w-row">
                  <div className="w-col w-col-5">
                    ...
                    <ul role="list" className="af-class-feature-list w-list-unstyled">
                      <li className="af-class-feature-item w-clearfix">
                        <div className="af-class-feature-icon-wrapper"><img src="images/icon_26icon_25.png" width={30} alt className="af-class-feature-icon" /></div>
                        <div className="af-class-feature-text af-class-title">Track your time on your phone.</div>
                        <div className="af-class-feature-text">Vivamus sollicitudin, felis vitae facilisis.</div>
                      </li>
                      <li className="af-class-feature-item w-clearfix">
                        <div className="af-class-feature-icon-wrapper"><img src="images/icon_4icon_03.png" width={30} alt className="af-class-feature-icon" /></div>
                        <div className="af-class-feature-text af-class-title">Create and edit all your projects.</div>
                        <div className="af-class-feature-text">Vivamus sollicitudin, felis vitae facilisis mollis, diam.</div>
                      </li>
                      <li className="af-class-feature-item w-clearfix">
                        <div className="af-class-feature-icon-wrapper"><img src="images/icon_9icon_08.png" width={30} alt className="af-class-feature-icon" /></div>
                        <div className="af-class-feature-text af-class-title">Send it and get paid.</div>
                        <div className="af-class-feature-text">Vivamus sollicitudin, felis vitae facilisis mollis.</div>
                      </li>
                    </ul>
                  </div>
                  <div className="af-class-image-column w-col w-col-7">
                    <div className="af-class-image-crop af-class-iphone"><img src="images/iPhone-flat2x.png" width={281} alt className="af-class-iphone-image" /></div>
                  </div>
                </div>
              </div>
            </div>
            <div className="af-class-section af-class-black af-class-wf-section">
              <div className="w-container">
                <div className="af-class-title">
                  ...
                  <p>No commitments. No credit cards required. Start your 14-day trial today!</p>
                </div>
                <div className="af-class-pricing-row w-row">
                  <div className="w-col w-col-4">
                    <div className="af-class-pricing-column">
                      ...
                      <a href="sign-up.html" className="af-class-get-started-link af-class-pricing">Get Started now&nbsp;&nbsp;&nbsp;❯</a>
                    </div>
                  </div>
                  <div className="w-col w-col-4">
                    <div className="af-class-pricing-column">
              ...
              <div className="w-row">
                ...
                <div className="af-class-padded-column w-col w-col-6">
                  <div className="af-class-width-limiter">
                    ...
                    <p>Our support is pretty cool. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla, ut commodo diam libero vitae erat. Aenean faucibus nibh et justo cursus id rutrum lorem imperdiet. Nunc ut sem vitae risus tristique posuere.</p>
                    <a href="contact.html" className="af-class-get-started-link af-class-simple">get support now</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="w-container">
                <div className="w-row">
                  ...
                  <div className="af-class-sign-up-column w-col w-col-4">
                    <a href="sign-up.html" className="af-class-button">SIGN UP TODAY&nbsp;&nbsp;&nbsp;❯</a>
                  </div>
                </div>
              </div>
            </div>
