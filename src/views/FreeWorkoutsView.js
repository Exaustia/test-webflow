...
class FreeWorkoutsView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '6171de626e35f71f1b76f3fb'
                ...
                <div className="af-class-container af-class-nav-container">
                  ...
                  <div className="af-class-nav-right-wrap">
                    <nav role="navigation" className="af-class-nav-menu w-nav-menu">
                      ...
                      <a href="free-workouts.html" aria-current="page" className="af-class-nav-link w-nav-link w--current">Free Workouts</a>
