...
class DetailAuthorView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '6171de626e35f77d9b76f3f9'
              ...
              <div className="af-class-section af-class-author-hero af-class-wf-section">
                <div className="af-class-container">
                  <div className="af-class-hero-slider-content">
                    <div id="w-node-ad7cd10b-54e4-9901-ddfb-577386584269-9b76f3f9" className="af-class-column af-class-max-600">
                      <div className="af-class-label af-class-_30-margin">Author</div>
                      <h1 />
                      <div className="w-richtext" />
                      <a href="#" className="af-class-button w-button" />
                    </div>
                    <div id="w-node-ad7cd10b-54e4-9901-ddfb-577386584273-9b76f3f9" className="af-class-column af-class-author-column">
