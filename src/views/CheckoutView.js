...
class CheckoutView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '6171de626e35f78c3476f3f4'
            ...
            <div className="af-class-page-wrap af-class-no-overflow">
              <div data-collapse="medium" data-animation="over-right" data-duration={400} data-easing="ease" data-easing2="ease" role="banner" className="af-class-navbar w-nav">
                <div className="af-class-container af-class-nav-container">
                  <a href="index.html" className="af-class-brand w-nav-brand"><img src="images/Black.svg" alt className="af-class-brand-logo" /></a>
                ...
                <div className="w-commerce-commercelayoutcontainer af-class-shipping-container w-container">
                  <div className="w-commerce-commercelayoutmain">
                    ...
                    <form data-node-type="commerce-checkout-customer-info-wrapper" className="w-commerce-commercecheckoutcustomerinfowrapper af-class-checkout-block">
                      ...
                      <fieldset className="w-commerce-commercecheckoutblockcontent af-class-block-content"><label className="w-commerce-commercecheckoutlabel af-class-field-label">Email *</label><input type="text" name="email" required className="w-commerce-commercecheckoutemailinput af-class-form-field af-class-checkout-field" /></fieldset>
                    </form>
                    <form data-node-type="commerce-checkout-shipping-address-wrapper" className="w-commerce-commercecheckoutshippingaddresswrapper af-class-checkout-block">
                      ...
                      <fieldset className="w-commerce-commercecheckoutblockcontent af-class-block-content"><label className="w-commerce-commercecheckoutlabel af-class-field-label">Full Name *</label><input type="text" name="name" required className="w-commerce-commercecheckoutshippingfullname af-class-form-field af-class-checkout-field" /><label className="w-commerce-commercecheckoutlabel af-class-field-label">Street Address *</label><input type="text" name="address_line1" required className="w-commerce-commercecheckoutshippingstreetaddress af-class-form-field af-class-checkout-field" /><input type="text" name="address_line2" className="w-commerce-commercecheckoutshippingstreetaddressoptional af-class-form-field af-class-checkout-field" />
                        <div className="w-commerce-commercecheckoutrow">
                          <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel af-class-field-label">City *</label><input type="text" name="address_city" required className="w-commerce-commercecheckoutshippingcity af-class-form-field af-class-checkout-field" /></div>
                          <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel af-class-field-label">State/Province</label><input type="text" name="address_state" className="w-commerce-commercecheckoutshippingstateprovince af-class-form-field af-class-checkout-field" /></div>
                          <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel af-class-field-label">Zip/Postal Code *</label><input type="text" name="address_zip" required data-node-type="commerce-checkout-shipping-zip-field" className="w-commerce-commercecheckoutshippingzippostalcode af-class-form-field af-class-checkout-field" /></div>
                        </div><label className="w-commerce-commercecheckoutlabel af-class-field-label">Country *</label><select name="address_country" className="w-commerce-commercecheckoutshippingcountryselector af-class-selector">
                    ...
                    <form data-node-type="commerce-checkout-billing-address-wrapper" style={{display: 'none'}} className="w-commerce-commercecheckoutbillingaddresswrapper af-class-checkout-block">
                      ...
                      <fieldset className="w-commerce-commercecheckoutblockcontent af-class-block-content"><label className="w-commerce-commercecheckoutlabel af-class-field-label">Full Name *</label><input type="text" name="name" required className="w-commerce-commercecheckoutbillingfullname af-class-form-field af-class-checkout-field" /><label className="w-commerce-commercecheckoutlabel af-class-field-label">Street Address *</label><input type="text" name="address_line1" required className="w-commerce-commercecheckoutbillingstreetaddress af-class-form-field af-class-checkout-field" /><input type="text" name="address_line2" className="w-commerce-commercecheckoutbillingstreetaddressoptional af-class-form-field af-class-checkout-field" />
                        <div className="w-commerce-commercecheckoutrow">
                          <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel af-class-field-label">City *</label><input type="text" name="address_city" required className="w-commerce-commercecheckoutbillingcity af-class-form-field af-class-checkout-field" /></div>
                          <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel af-class-field-label">State/Province</label><input type="text" name="address_state" className="w-commerce-commercecheckoutbillingstateprovince af-class-form-field af-class-checkout-field" /></div>
                          <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel af-class-field-label">Zip/Postal Code *</label><input type="text" name="address_zip" required data-node-type="commerce-checkout-billing-zip-field" className="w-commerce-commercecheckoutbillingzippostalcode af-class-form-field af-class-checkout-field" /></div>
                        </div><label className="w-commerce-commercecheckoutlabel af-class-field-label">Country *</label><select name="address_country" className="w-commerce-commercecheckoutbillingcountryselector af-class-selector">
                          <option value="AF">Afghanistan</option>
                          <option value="AX">Aland Islands</option>
                          <option value="AL">Albania</option>
                          <option value="DZ">Algeria</option>
