...
class ServicesView extends React.Component {
  ...
  render() {
    const proxies = ServicesView.Controller !== ServicesView ? transformProxies(this.props.children) : {
            ...
            <div data-collapse="medium" data-animation="default" data-duration={400} data-easing="ease" data-easing2="ease" role="banner" className="af-class-navbar w-nav">
              <div className="w-container">
                ...
                <nav role="navigation" className="af-class-nav-menu w-clearfix w-nav-menu">
                  ...
                  <a href="services.html" aria-current="page" className="af-class-nav-link w-nav-link w--current">services</a>
                  ...
                  <a href="contact.html" className="af-class-nav-link af-class-right w-nav-link">SIGN UP</a>
                </nav>
              ...
              <div className="w-container">
                <div className="w-row">
                  <div className="w-col w-col-8">
                    ...
                    <a href="#" className="af-class-get-started-link">Get started now&nbsp;&nbsp;&nbsp;❯&nbsp;</a>
                  </div>
                  <div className="af-class-center w-col w-col-4"><img src="images/All-devices.png" srcSet="images/All-devices-p-500x288.png 500w, images/All-devices.png 1131w" sizes="(max-width: 479px) 64vw, (max-width: 767px) 46vw, (max-width: 991px) 229.328125px, 299.984375px" alt className="af-class-all-devices-image" /></div>
                </div>
              </div>
            </div>
              ...
              <div className="w-container">
                <div className="w-row">
                  <div className="w-col w-col-6">
                    <ul role="list" className="af-class-feature-list af-class-no-padding w-list-unstyled">
